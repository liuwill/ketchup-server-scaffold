module.exports = {
  ERRORS: {
    ...
    // 获取ACCESS_TOKEN
    ERR_GET_ACCESS_TOKEN: 'ERR_GET_ACCESS_TOKEN',

    // 模版消息
    ERR_SEND_TEMPLATE: 'ERR_SEND_TEMPLATE',

    // 二维码
    ERR_GET_QR_CODE_UNLIMITED: 'ERR_GET_QR_CODE_UNLIMITED',
  ...
  WX_CODE2SESSION_API_URL: 'https://api.weixin.qq.com/sns/jscode2session',
  WX_PRE_PAY_URL: 'https://api.mch.weixin.qq.com/pay/unifiedorder',
  WX_ACCESS_TOKEN_URL: 'https://api.weixin.qq.com/cgi-bin/token',
  WX_QR_CODE_UNLIMITED_URL: 'https://api.weixin.qq.com/wxa/getwxacodeunlimit',
  WX_TEMPLATE_SEND_URL: 'https://api.weixin.qq.com/cgi-bin/message/wxopen/template/send',
}
